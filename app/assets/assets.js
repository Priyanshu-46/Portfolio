...
export const serviceData = [
    ...
    {  id:1,icon: assets.mobile_icon, title: 'DevOps and API Integration', description: 'Crafting intuitive and visually appealing user interfaces using modern frameworks like React and Next.js', link: 'https://github.com/Priyanshu-46' },
    ...
    {  id:3,icon: assets.graphics_icon, title: 'Website Optimization & Maintenance', description: 'Enhancing website performance, ensuring fast load times, and providing ongoing updates and support.', link: 'https://github.com/Priyanshu-46' },
]

export const infoList = [
    {id:0, icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS, JavaScript, Java, SQL, C' },
...
export const EXPERIENCES = [
  ...
  export const CODING_STATS=[
    {  
      ...
      title:"LeetCode",
      image: LeetCodeLogo, 
      profileLink:"https://leetcode.com/u/_priyanshu_1/", 
      description: "I have successfully completed 50+ coding challenges on LeetCode, showcasing my proficiency in problem-solving and algorithmic thinking.",
      problemsSolved: '50+', 
    },
  ]